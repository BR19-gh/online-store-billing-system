...
function firstFetch() {
    ...
    <div id="form" class="card" style="width: 18rem;">
        <img style="width: 257px; height: 257px;" src="data:image/png;base64,${data[i]["img"]}" class="card-img-top" alt="cookies">
        <div class="card-body">
...
`
                                    ...
                                    var allButtons = document.querySelectorAll('a[class^=card-link addToCartBtn]');
                                    console.log("Found", allButtons.length, 'a which class:"card-link addToCartBtn".');
