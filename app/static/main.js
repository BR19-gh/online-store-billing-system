...
function firstFetch() {
    ...
    <div id="form" class="card" style="width: 18rem;">
        <img style="width: 257px; height: 257px;" src="../static/img/products_imgs/${data[i]["imgName"]}" class="card-img-top" alt="cookies">
        <div class="card-body">
...
`
                                    ...
                                    var allButtons = document.querySelectorAll('div[class^=addToCartBtn]');
                                    console.log("Found", allButtons.length, 'div which class:"addToCartBtn".');
