                                                        ...
                                                        .then((responseJson) => {
                                                                ...
                                                                document
                                                                    ...
                                                                    .addEventListener(
                                                                        ...
                                                                        () => {
                                                                            // let listOfImgs;
                                                                            // let innerTextOfGroupOfTitles = document.querySelector('#groupOfTitles').innerText.split('\n');
                                                                            // if (listOfTitles.length !== 0) listOfImgs = convertTitleToImg(listOfTitles, data);
                                                                            // innerTextOfGroupOfTitles
