...
function expOrNarProduct(expOrNarProductKey) {
    if (expOrNarProductKey == 1) {
        ...
        productsList.childNodes[
            ...
            '<div class="expOrNar" id="expOrNarProduct" onclick="expOrNarProduct(0)" style="cursor: pointer; display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px">اضغط لإخفاء المنتجات &nbsp;  <i class="fas fa-angle-up"></i></div>'
...
function expOrNarPromo(expOrNarPromoKey) {
    if (expOrNarPromoKey == 1) {
        ...
        codesList.childNodes[
            ...
            '<div class="expOrNar" id="expOrNarPromo" onclick="expOrNarPromo(0)" style="cursor: pointer; display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px">اضغط لإخفاء القسائم &nbsp;  <i class="fas fa-angle-up"></i></div>'
