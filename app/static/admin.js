...
function isNarrowed(responseJson) {
    ...
    for (let i = 0; i < Object.keys(responseJson).length; i++) {
        ...
        if (i == Object.keys(responseJson).length) {
            document.querySelector('#productsList').innerHTML += `<div style="display: flex; justify-content: space-around; color: #4b4b4b;"><b>${responseJson[Object.keys(responseJson)[i]]['id']}</b><b>${responseJson[Object.keys(responseJson)[i]]['title']}</b><b>${responseJson[Object.keys(responseJson)[i]]['price']}﷼</b><b style="display:flex;justify-content:space-around;"><img style="border: 1px solid #8f8d85 ; border-radius: 10px; width: 30px; height: 30px; margin: 0;" src="data:image/png;base64,${responseJson[Object.keys(responseJson)[i]]['img']}" alt="img"></b><b><div data-bs-toggle="modal" data-bs-target="#productModal" onclick="deleteOrEditPromoPupup(${responseJson[Object.keys(responseJson)[i]]['id']},'edit')"><i class="fa-solid fa-pen-to-square"></i></div>|<div data-bs-toggle="modal" data-bs-target="#productModal" onclick="deleteOrEditProductPupup(${responseJson[Object.keys(responseJson)[i]]['id']},'delete')><i class="fa-solid fa-trash-can"></i></div></b></div>`;
        }

        document.querySelector('#productsList').innerHTML += `<div style="display: flex; justify-content: space-around; color: #4b4b4b;"><b>${responseJson[Object.keys(responseJson)[i]]['id']}</b><b>${responseJson[Object.keys(responseJson)[i]]['title']}</b><b>${responseJson[Object.keys(responseJson)[i]]['price']}﷼</b><b style="display:flex;justify-content:space-around;"><img style="border: 1px solid #8f8d85 ; border-radius: 10px; width: 30px; height: 30px; margin: 0;" src="data:image/png;base64,${responseJson[Object.keys(responseJson)[i]]['img']}" alt="img"></b><b><div data-bs-toggle="modal" data-bs-target="#productModal" onclick="deleteOrEditPromoPupup(${responseJson[Object.keys(responseJson)[i]]['id']},'edit')"><i class="fa-solid fa-pen-to-square"></i></div>|<div data-bs-toggle="modal" data-bs-target="#productModal" onclick="deleteOrEditProductPupup(${responseJson[Object.keys(responseJson)[i]]['id']},'delete')><i class="fa-solid fa-trash-can"></i></div></b></div><br><div></div>`;
    }
}
