...
function expOrNarProduct(expOrNarProductKey) {
    if (expOrNarProductKey == 1) {
        ...
        productsList.childNodes[0].innerHTML = `<b class="cell">الرقم</b><b class="cell">العنوان</b><b class="cell">السعر</b><b class="cell">الصورة</b><b class="cell">إجراءات</b>`;
...
function expOrNarPromo(expOrNarPromoKey) {
    if (expOrNarPromoKey == 1) {
        ...
        codesList.childNodes[0].innerHTML = `<b class="cell">الرقم</b><b class="cell">الاسم</b><b class="cell">النسبة</b><b class="cell">إجراءات</b>`;
...
function deleteOrEditProd(id, opration) {
    if (opration == 'edit') {
        ...
        document.querySelector('#browseImg').innerHTML = `<img style="border: 1px solid #8f8d85 ; border-radius: 10px; width: 30px; height: 30px; margin: 0;" src="data:image/png;base64,${listOfProducts[id]['img']}" alt="img"> يمكنك حفظ الصورة من هذا المربع ورفعها مجددا إذا كنت لا تريد تغييرها`;
        //disable input
