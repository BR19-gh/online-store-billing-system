...
function expOrNarProduct(expOrNarProductKey) {
    if (expOrNarProductKey == 1) {
        document.getElementById('productsList').classList.remove("narrowListAnimation");
        document.getElementById('productsList').classList.add("expandListAnimation");
        ...
        document.getElementById('productsList').classList.add("narrowListAnimation");
        document.getElementById('productsList').classList.remove("expandListAnimation");
...
function expOrNarPromo(expOrNarPromoKey) {
    if (expOrNarPromoKey == 1) {
        document.getElementById('codesList').classList.remove("narrowListAnimation");
        document.getElementById('codesList').classList.add("expandListAnimation");
        ...
        document.getElementById('codesList').classList.add("narrowListAnimation");
        document.getElementById('codesList').classList.remove("expandListAnimation");
...
function firstFetch() {
    ...
    fetch('/products', {
        ...
        .then((response) => {
            ...
            document.getElementById('productsList').innerHTML = '<div id="expOrNarProduct" onclick="expOrNarProduct(1)" style="cursor: pointer; display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fas fa-angle-down"></i> اضغط لإظهار المنتجات </div><div style="display: flex; justify-content: space-evenly; border-bottom: rgba(0,0,0,.125) solid 1px; padding-bottom: 3px; font-size: 20px"><b>الرقم</b><b>العنوان</b><b>السعر</b><b>الصورة</b></div>'
