...
function deleteOrEditProd(id, opration) {
    if (opration == 'edit') {
        ...
        document.querySelector('#browseImg').innerHTML = `يمكنك حفظ الصورة الحالية من هذا المربع <img style="border: 1px solid #8f8d85 ; border-radius: 10px; width: 45px; height: 45px; margin: 0;" src="data:image/png;base64,${listOfProducts[id]['img']}" alt="img"> ورفعها مجددا إذا كنت لا تريد تغييرها`;
        //disable input
