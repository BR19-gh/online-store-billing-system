...
function expOrNarProduct(expOrNarProductKey) {
    if (expOrNarProductKey == 1) {
        document.getElementsById('productsList').style.height = "100%";
        productsList.childNodes[Object.keys(productsList.childNodes).length - 1].innerHTML = '<div id="expOrNarProduct" onclick="expOrNarProduct(0)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-up"></i> إضغط لإخفاء المنتجات</div>';
        productsList.childNodes[0].innerHTML = "";

    } else {
        document.getElementsById('productsList').style.height = "50px";
        productsList.childNodes[0].innerHTML = '<div id="expOrNarProduct" onclick="expOrNarProduct(1)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-up"></i> إضغط لإظهار المنتجات</div>';
    }
...
function expOrNarPromo(expOrNarPromoKey) {
    if (expOrNarPromoKey == 1) {
        document.getElementsById('codesList').style.height = "100%";
        codesList.childNodes[Object.keys(productsList.childNodes).length - 1].innerHTML = '<div id="expOrNarPromo" onclick="expOrNarPromo(0)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-up"></i> إضغط لإخفاء المنتجات</div>';
        codesList.childNodes[0].innerHTML = "";

    } else {
        document.getElementsById('codesList').style.height = "50px";
        codesList.childNodes[0].innerHTML = '<div id="expOrNarPromo" onclick="expOrNarPromo(1)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-up"></i> إضغط لإظهار المنتجات</div>';
    }
...
function firstFetch() {
    ...
    fetch('/products', {
        ...
        .then((response) => {
            ...
            document.getElementById('productsList').innerHTML = '<div id="expOrNarProduct" onclick="expOrNarProduct(1)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-down"></i> إضغط لإظهار المنتجات</div><div style="display: flex; justify-content: space-evenly; border-bottom: rgba(0,0,0,.125) solid 1px; padding-bottom: 3px; font-size: 20px"><b>الرقم</b><b>العنوان</b><b>السعر</b><b>الصورة</b></div>'
            for (let i = 0; i < Object.keys(responseJson).length; i++) {

                if (i == Object.keys(responseJson).length) {
                    document.getElementById('productsList').innerHTML += `<div style="display: flex; justify-content: space-evenly; color: #4b4b4b;"><b>${responseJson[Object.keys(responseJson)[i]]['id']}</b><b>${responseJson[Object.keys(responseJson)[i]]['title']}</b><b>${responseJson[Object.keys(responseJson)[i]]['price']}﷼</b><b><img style="border: 1px solid #8f8d85 ; border-radius: 10px; width: 30px; height: 30px; margin: 0;" src="data:image/png;base64,${responseJson[Object.keys(responseJson)[i]]['img']}" alt="img"></b></div>`;
                }
    ...
    fetch('/promocodes', {
        ...
        .then((response) => {
            ...
            document.getElementById('codesList').innerHTML = '<div id="expOrNarPromo" onclick="expOrNarPromo(1)" style="display: flex; justify-content: center; padding-bottom: 3px; font-size: 20px"><i class="fa-solid fa-angle-down"></i> إضغط لرؤية الأكواد</div><div style="display: flex; justify-content: space-evenly; border-bottom: rgba(0,0,0,.125) solid 1px; padding-bottom: 3px; font-size: 20px"><b>الرقم</b><b>الاسم</b><b>النسبة</b></div>'
            for (let i = 0; i < Object.keys(responseJson).length; i++) {

                if (i == Object.keys(responseJson).length) {
                    document.getElementById('codesList').innerHTML += `<div style="display: flex; justify-content: space-evenly; color: #4b4b4b;"><b>${responseJson[Object.keys(responseJson)[i]]['id']}</b><b>${responseJson[Object.keys(responseJson)[i]]['code']}</b><b>${responseJson[Object.keys(responseJson)[i]]['amount']*100}%</b></div>`;
                }
                document.getElementById('codesList').innerHTML += `<div style="display: flex; justify-content: space-evenly; color: #4b4b4b;"><b>${responseJson[Object.keys(responseJson)[i]]['id']}</b><b>${responseJson[Object.keys(responseJson)[i]]['code']}</b><b>${responseJson[Object.keys(responseJson)[i]]['amount']*100}%</b></div><br><div></div>`;
            }
        });
